...
// @access  Private
router.post('/', protect, orderValidation.create, asyncHandler(async (req, res) => {
  const { items, shippingAddress, paymentMethod, prescription, notes } = req.body;
...
router.put('/:id/status', protect, isPharmacistOrAdmin, validateObjectId, asyncHandler(async (req, res) => {
...
router.put('/:id/cancel', protect, validateObjectId, asyncHandler(async (req, res) => {
  const order = await Order.findById(req.params.id);
...
// @desc    Track order
// @access  Private
router.get('/:id/track', protect, validateObjectId, asyncHandler(async (req, res) => {
  const order = await Order.findById(req.params.id)
    .select('orderNumber status trackingHistory estimatedDelivery actualDelivery');
...
router.post('/:id/dispense', protect, isPharmacistOrAdmin, validateObjectId, asyncHandler(async (req, res) => {
