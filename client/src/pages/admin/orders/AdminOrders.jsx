    ...
    <div className="dashboard-layout">
      ...
      <main className="dashboard-main">
        ...
        <div className="order-stats">
          <div
            className={`stat-box ${statusFilter === "all" ? "selected" : ""}`}
          ...
          <div
            className={`stat-box pending ${statusFilter === "pending" ? "selected" : ""}`}
          ...
          <div
            className={`stat-box processing ${statusFilter === "processing" ? "selected" : ""}`}
          ...
          <div
            className={`stat-box delivered ${statusFilter === "delivered" ? "selected" : ""}`}
