                ...
                <div style={{ display: 'grid', gridTemplateColumns: '360px 1fr', gap: '2rem' }}>
                    ...
                    <div style={card}>
                        <div style={{ padding: '1rem 1.5rem', borderBottom: '1px solid #f1f5f9', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                            <span style={{ fontWeight: 700, display: 'flex', alignItems: 'center', gap: '0.5rem' }}><FiClock style={{ color: '#9ca3af' }} /> History</span>
                            <span style={{ fontSize: '0.8rem', background: '#f1f5f9', padding: '0.25rem 0.75rem', borderRadius: '9999px' }}>{prescriptions.length} Records</span>
                        </div>
                        {loading ? (
                            ...
                            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '1rem', padding: '1.5rem' }}>
                                {prescriptions.map(p => (
                                    <div key={p._id} style={{ background: '#f9fafb', borderRadius: '0.75rem', overflow: 'hidden', border: '1px solid #e5e7eb' }}>
