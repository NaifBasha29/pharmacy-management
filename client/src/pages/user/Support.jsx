  ...
  const faqs = [
    {
      ...
      a: "Go to My Orders page, click on any order to expand details and see the current status. Once dispatched, you can track the shipment in real-time.",
    },
    {
      q: "How long does delivery take?",
      a: "Standard delivery takes 2-5 business days. Express delivery (available in select cities) delivers within 24 hours.",
    },
    {
      q: "Can I cancel my order?",
      a: 'You can cancel orders that are still in "Pending" status. Go to My Orders, find the order, and click Cancel. Refunds are processed within 5-7 business days.',
    },
    {
      q: "What payment methods are accepted?",
      a: "We accept Credit/Debit Cards, UPI, Net Banking, and Cash on Delivery (COD) for orders under ₹5000.",
    },
    {
      q: "How do I upload a prescription?",
      a: "Go to the Prescriptions page, click Upload, select your prescription image or PDF, and submit. Our pharmacists will verify it within 2 hours.",
    },
    {
      q: "Is my health information secure?",
      a: "Yes, all your health data is encrypted and stored securely. We follow strict HIPAA compliance guidelines and never share your information with third parties.",
    },
  ];
      ...
      <main className="dashboard-main" style={page}>
        ...
        >
          {[
            ...
            { id: "ticket", label: "Submit Ticket", icon: <FiSend /> },
          ].map((tab) => (
            <button
              key={tab.id}
              ...
              style={{
                ...
                color:
                  activeSection === tab.id
                    ...
                    : "var(--text-secondary)",
                background:
                  activeSection === tab.id ? "#eff6ff" : "transparent",
                border: "none",
                borderRadius: "0.5rem",
                cursor: "pointer",
              }}
            ...
            <div>
              ...
              <div
                style={{
                  ...
                  padding: "1.5rem",
                  marginTop: "1rem",
                  background: "linear-gradient(135deg, #fff7ed, #d1fae5)",
                }}
              >
                <div
                  style={{
