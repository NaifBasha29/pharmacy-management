...
const FAQS = [
  ...
  },
  {
    ...
    a: 'We currently accept select insurance plans. Please email us at support@pharmacare.com with your insurance details for verification.',
  },
  {
...
export default function SupportScreen({ navigation }) {
  ...
  const handleContact = (action) => {
    ...
    if (action === 'email') Linking.openURL('mailto:support@pharmacare.com');
